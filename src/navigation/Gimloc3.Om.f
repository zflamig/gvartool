...
C       
        ...
        ELVMAX(2)=0.22089375D0

        SCNMAX(1)=0.24544D0

        SCNMAX(2)=0.2454375D0
...
C        ELVMAX(INSTR)=((9-NS_NAD_CY)*INCMAX(INSTR)-NS_NAD_INC)
...
C      SCNMAX(INSTR) = (EW_NAD_CY*INCMAX(INSTR)+EW_NAD_INC)*SCNINC(INSTR)
...
C**                        REFERENCE RADIAL DISTANCE, LATITZDE AND
...
C**   ATTITZDE OF THE IMAGER OR SOUNDER.  THE CALCULATIONS ARE BASED            

C**   ON THE OATS ORBIT AND ATTITZDE MODEL REPRESENTED BY THE O&A               
...
C**          GEOGRAPHIC LATITZDE AND LONGITZDE AT SUBSATELLITE POINT.           
...
C**   POSITION OF THE SATELLITE, THE ATTITZDE ANGLES AND ATTITZDE               
...
C                                   SUBSATELLITE GEODETIC LATITZDE (RAD)        

      REAL*8 RLON                                                               

C                                   SUBSATELLITE LONGITZDE IN RADIANS           
...
C                    SUBSATELLITE GEOCENTRIC LATITZDE IN RADIANS                
...
C                    IMC LONGITZDE (IN RADIANS)                                 

      REAL*8  U                                                                 

C                    ARGUMENT OF LATITZDE (IN RADIANS)                          
...
C                    SINE OF GEOCENTRIC LATITZDE                                

      REAL*8 ASC                                                                

C                    LONGITZDE OF THE ASCENDING NODE IN RADIANS                 
...
C                    CHANGE IN SINE OF GEOCENTRIC LATITZDE                      
...
C     ASSIGN REFERENCE VALUES TO THE SUBSATELLITE LONGITZDE AND                 

C     LATITZDE, THE RADIAL DISTANCE AND THE ORBIT YAW.                          
...
C     ASSIGN REFERENCE VALUES TO THE ATTITZDES AND MISALIGNMENTS                
...
C     SET REFERENCE RADIAL DISTANCE, LATITZDE AND ORBIT YAW TO ZERO
...
C     COMPUTES CHANGE IN THE IMC LONGITZDE FROM THE REFERENCE                   
...
C     COMPUTES THE SINE OF THE CHANGE IN THE GEOCENTRIC LATITZDE                
...
C     COMPUTES GEOCENTRIC LATITZDE BY USING AN EXPANSION FOR ARCSINE            
...
C     CONVERSION OF THE IMC LONGITZDE AND ORBIT YAW TO THE SUBSATELLITE         

C     LONGITZDE AND THE ORBIT INCLINATION (REF: GOES-PCC-TM-2473, INPUTS        
...
C     COMPUTES LONGITZDE OF THE ASCENDING NODE                                  
...
C     COMPUTES THE SUBSATELLITE GEOGRAPHIC LATITZDE                             
...
C     COMPUTES THE SUBSATELLITE LONGITZDE                                       
...
C     COMPUTES THE ATTITZDES AND MISALIGNMENTS IF IMC IS OFF                    
...
C**   THIS SUBROUTINE CONVERTS GEOGRAPHIC LATITZDE AND LONGITZDE                
...
C                             GEOGRAPHIC LATITZDE IN RADIANS (INPUT)            

      REAL*8   RLON                                                             

C                             GEOGRAPHIC LONGITZDE IN RADIANS (INPUT)           
...
C     COMPUTES SINUS OF GEOGRAPHIC (GEODETIC) LATITZDE                          
...
C     SINUS OF THE GEOCENTRIC LATITZDE                                          
...
C**   ANGLES TO THE RELATED GEOGRAPHIC LATITZDE AND LONGITZDE.                  
...
C                             LATITZDE IN RADIANS (OUTPUT)                      

      REAL*8   RLON                                                             

C                             LONGITZDE IN RADIANS (OUTPUT)                     
...
C     SINUS OF GEOCENTRIC LATITZDE                                              
...
C**   LOCATIONS IN LATITZDE/LONGITZDE COORDINATES.                              
...
C                            GEO(*,1) = LATITZDE IN RADIANS                     

C                            GEO(*,2) = LONGITZDE IN RADIANS                    
...
C     NOTE:  IF A DETECTOR LOOKS OFF THE EARTH, THE RELATED LATITZDE            

C            AND LONGITZDE ARE SET TO 999999.                                   
...
C**    THIS FUNCTION COMPUTES AN ATTITZDE/MISALIGNMENT ANGLE FROM A             
...
C      DLAT ---------- LATITZDE  (NEGATIVE IS SOUTH)(F9.5)

C      DLON ---------- LONGITZDE (NEGATIVE IS WEST)(F10.5)
